package com.harmony.recommendation_service.dto;
...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Kafka event representing a song play transition, consumed from the Streaming service " +
        "to build the recommendation transition graph")
